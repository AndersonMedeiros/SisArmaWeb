...
<% List<Destino> listaDestino = new Relatorio().destinoCautelado(); %>
    ...
    <script>
        ...
        type: 'bar',
                ...
                labels: [<%for (Destino des : listaDestino) {%> "<%=des.toString()%>",<%}%>],
                        datasets: [{
                        label: 'Quantidade de equipamentos cautelados no momento',
      ...
      options: {
        title:{
         display: true,
         fontSize: 20,
         text: "Destino dos Equipamentos que estão Cautelados "
        }
      },
        });
    </script>
